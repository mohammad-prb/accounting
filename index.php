            ...
            <div class="kadrSBT" id="kadrSBTK">
                ...
                <div class="kadrEtelaatSBT">
                    ...
                    <div class="etelaatSBT">
                        ...
                        <select name="dasteh">
                            <?php
                            $sql = "select id, onvan, noe from tbl_dasteh where hesabID = 1 and vaziat = 1 order by onvan";
                            $result = $con->query($sql);
                            if ($result !== false && $result->num_rows > 0)
                            {
                                while ($row = $result->fetch_assoc())
            ...
            <div class="kadrSBT" id="kadrSBTV">
                ...
                <div class="kadrEtelaatSBT">
                    ...
                    <div class="etelaatSBT">
                        ...
                        <select name="dasteh">
                            <?php
                            $sql = "select id, nam, noe from tbl_afrad where hesabID = 1 and vaziat = 1 order by nam";
                            $result = $con->query($sql);
                            if ($result !== false && $result->num_rows > 0)
                            {
                                while ($row = $result->fetch_assoc())
