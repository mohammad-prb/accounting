...
<body dir="rtl" onload="tanzimSafAFD();gereftanAfrad();">
    ...
    <div id="sotoonChap">
        ...
        <div id="kadrRahnama">
            <div id="kadrVasetRahnama">
                <a href="javascript:void(0);" onclick="taghirNoeAFD(this);" class="rahnama" data-vaziat="1"><span class="icon"></span><span class="matnTitr">مشترک</span></a>
