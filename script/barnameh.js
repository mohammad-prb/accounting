...
/*      بازو بست فیلتر      */
function bazoBastFilterBRN(lmn)
{
    var lmnKadr = document.getElementById("kadrVasetBRN");
    if (Number(lmnKadr.dataset.vaziat) === 1)
    {
        ...
        document.getElementById("kadrVasetBtnBRN").style.width = "0";
    }
    else
    {
        lmnKadr.dataset.vaziat = 1;
        if (mobileAst(1000)) lmnKadr.style.maxHeight = "328px";
        else lmnKadr.style.maxHeight = "153px";
        window.addEventListener("resize", ()=>{
            if (mobileAst(1000) && lmnKadr.style.maxHeight === "153px") lmnKadr.style.maxHeight = "328px";
            else if (!mobileAst(1000) && lmnKadr.style.maxHeight === "328px") lmnKadr.style.maxHeight = "153px";
        });
        ...
        document.getElementById("kadrVasetBtnBRN").style.width = "calc(100% - 47px)";
