<div id="kadrFilterBRN">
    <div id="kadrVasetBRN" data-vaziat="0">
    ...
    <a href="javascript:void(0);" onclick="bazoBastFilterBRN(this);" id="btnBazoBastBRN"><span class="icon"></span><span class="matnTitr">فیلتر</span></a>
    <div id="kadrVasetBtnBRN">
